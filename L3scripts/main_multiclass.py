...
def main():
    ...
    #PATH = '../DATA_input/'
    TRAIN_PATH = '../DATA_input/train/'
    VALID_PATH = '../DATA_input/validation/'
    CHECK_PATH = "./weights/"
    ...
    BATCH_SIZE = 1
    train_gen = trainGenerator(BATCH_SIZE,TRAIN_PATH,'image','label',data_gen_args, save_to_dir = None)
    val_gen = valGenerator(BATCH_SIZE,VALID_PATH,'image','label', save_to_dir = None)
    ...
    #Fit the u-net model
    model_checkpoint = tf.keras.callbacks.ModelCheckpoint(os.path.join(CHECK_PATH, 'unet_DB1_multi.hdf5'),
